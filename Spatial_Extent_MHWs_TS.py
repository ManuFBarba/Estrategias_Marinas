...
##Load MHWs_from_MATLAB




### SPATIAL EXTENT OF MHW ACTIVITIES ###
...
Td_GC_ts = np.nanmean(MHW_td_ts_GC_MODEL, axis=(0, 1))
...
Bottom_Td_GC_ts = np.nanmean(BMHW_td_ts_GC_MODEL, axis=(0, 1))
...
Td_GC_ts = np.nan_to_num(Td_GC_ts, nan=0.0)
...
error_Td_GC = (np.nanstd(MHW_td_ts_GC_MODEL, axis=(0, 1)) / np.sqrt(30)) 
...
error_bottom_Td_GC = (np.nanstd(BMHW_td_ts_GC_MODEL, axis=(0, 1)) / np.sqrt(30)) 
...
normalized_error_Td_GC = normalize_error(error_Td_GC, min_error_range, max_error_range) 
...
normalized_error_bottom_Td_GC = normalize_error(error_bottom_Td_GC, min_error_range, max_error_range) 
...
fraction_area_GC = calculate_fraction_area(MHW_td_ts_GC_MODEL, threshold)
...
Bottom_fraction_area_GC = calculate_fraction_area(BMHW_td_ts_GC_MODEL, threshold)
...
Max_fraction_area_GC = np.nanmax(fraction_area_GC, axis=0)
...
Bottom_td_fraction_area_GC = np.nanmax(Bottom_fraction_area_GC, axis=0)
...
norm_fraction_area_GC = fraction_area_GC / Max_fraction_area_GC
...
Bottom_norm_fraction_area_GC = Bottom_fraction_area_GC / Bottom_td_fraction_area_GC
...
norm_fraction_area_GC = np.clip(norm_fraction_area_GC, 0, 1)
...
# Adding SMHWs bars
cs4 = axs4.bar(time, norm_fraction_area_GC, color=cmap.to_rgba(Td_GC_ts))

# Adding normalized error lines in SMHW
for i, rect in enumerate(cs4):
    x = rect.get_x() + rect.get_width() / 2
    y = rect.get_height()
    error = normalized_error_Td_GC[i]
    axs4.errorbar(x, y, yerr=error, color='black', alpha=0.5, capsize=5)

#BMHWs scatter
css4 = axs4.scatter(time, Bottom_norm_fraction_area_GC, color=cmap_bottom.to_rgba(Bottom_Td_GC_ts), edgecolors='black', alpha=1, zorder=10)
...
for i, point in enumerate(scatter_points):
    x, y = point  # Get x and y coordinates
    error = normalized_error_bottom_Td_GC[i]
...
outfile = r'C:\Users\Manuel\Desktop\Paper_EEMM_MHWs\Figuras_Paper_EEMM\Fig_5\Spatial_Extent_MHW_Td.png'
...
Max_GC_ts = np.nanmean(MHW_max_ts_GC_MODEL, axis=(0, 1))
...
Bottom_Max_GC_ts = np.nanmean(BMHW_max_ts_GC_MODEL, axis=(0, 1))
...
Max_GC_ts = np.nan_to_num(Max_GC_ts, nan=0.0)
...
max_Max_GC = np.nanmax(MHW_max_ts_GC_MODEL, axis=(0, 1))
...
fraction_area_GC = calculate_fraction_area(MHW_max_ts_GC_MODEL, threshold)
...
Bottom_fraction_area_GC = calculate_fraction_area(BMHW_max_ts_GC_MODEL, threshold)
...
Bottom_max_fraction_area_GC = np.nanmax(Bottom_fraction_area_GC, axis=0)
...
Bottom_norm_fraction_area_GC = Bottom_fraction_area_GC / Bottom_max_fraction_area_GC
...
# Adding SMHWs bars
cs4 = axs4.bar(time, norm_fraction_area_GC, color=cmap.to_rgba(Max_GC_ts))
...
#BMHWs scatter
css4 = axs4.scatter(time, Bottom_norm_fraction_area_GC, color=cmap_bottom.to_rgba(Bottom_Max_GC_ts), edgecolors='black', alpha=1, zorder=10)
...
outfile = r'C:\Users\Manuel\Desktop\Paper_EEMM_MHWs\Figuras_Paper_EEMM\Fig_5\Spatial_Extent_MHW_MaxInt.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
Cum_GC_ts = np.nanmean(MHW_cum_ts_GC_MODEL, axis=(0, 1))
...
Bottom_Cum_GC_ts = np.nanmean(BMHW_cum_ts_GC_MODEL, axis=(0, 1))
...
Cum_GC_ts = np.nan_to_num(Cum_GC_ts, nan=0.0)
...
fraction_area_GC = calculate_fraction_area(MHW_cum_ts_GC_MODEL, threshold)
...
Bottom_fraction_area_GC = calculate_fraction_area(BMHW_cum_ts_GC_MODEL, threshold)
...
# Adding SMHWs bars
cs4 = axs4.bar(time, norm_fraction_area_GC, color=cmap.to_rgba(Cum_GC_ts))
...
#BMHWs scatter
css4 = axs4.scatter(time, Bottom_norm_fraction_area_GC, color=cmap_bottom.to_rgba(Bottom_Cum_GC_ts), edgecolors='black', alpha=1, zorder=10)
...
outfile = r'C:\Users\Manuel\Desktop\Paper_EEMM_MHWs\Figuras_Paper_EEMM\Fig_5\Spatial_Extent_MHW_CumInt.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
