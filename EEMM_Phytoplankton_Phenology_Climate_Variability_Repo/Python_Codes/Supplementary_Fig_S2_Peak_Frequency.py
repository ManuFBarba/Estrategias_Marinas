...
for i, data in enumerate(data_demarcations):
    ...
    if i == 0:
        axs[i].set_ylim(40, 183)
        axs[i].set_yticks([40, 59.0, 91.5, 122.0, 152.5, 183])
        axs[i].set_yticklabels(['', 'Mar', '', '','', 'Jul'], fontsize=45) 
    if i == 1:
    ...
    if i == 2:
        ...
        axs[i].set_yticks([0, 30.5, 59.0, 91.5, 122.0, 152.5, 183.0, 213.5, 244.0, 274.5, 305.0, 336])
        axs[i].set_yticklabels(['Jan', '', '', '', '', '', '', '', '', '', '', 'Dec'], fontsize=45) 
        axs[i].set_ylabel(r'BPeak $\mathrm{[days]}$', fontsize=45, labelpad=15)
    if i == 3:
        axs[i].set_ylim(0, 366)
        axs[i].set_yticks([0, 30.5, 59.0, 91.5, 122.0, 152.5, 183.0, 213.5, 244.0, 274.5, 305.0, 336])
        axs[i].set_yticklabels(['Jan', '', '', '', '', '', '', '', '', '', '', 'Dec'], fontsize=45) 
...
## Fig. S2f (Boxplots Bloom Frequency)  ##CORREGIR Y-AXES!!!
years = np.arange(1998, 2024)
...
for i, data in enumerate(data_demarcations):
    ...
    if i == 0: 
        ...
        axs[i].set_yticklabels([1, '', '', '', 5], fontsize=45) 
    if i == 1:  
    ...
    if i == 2:
        ...
        axs[i].set_yticks([1, 2, 3, 4, 5])
        axs[i].set_yticklabels([1, '', '', '', 5], fontsize=45) 
        axs[i].set_ylabel(r'BFreq [count]', fontsize=45, labelpad=15)
    if i == 3:
        axs[i].set_ylim(1, 5)
        axs[i].set_yticks([1, 2, 3, 4, 5])
        axs[i].set_yticklabels([1, '', '', '', 5], fontsize=45) 
    if i == 4:
        ...
        axs[i].set_yticklabels(['', 2, '', 4], fontsize=45) 
