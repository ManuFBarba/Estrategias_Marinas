...
# ds_1 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Canarias/SST_1982_1990.nc')
# ds_2 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Canarias/SST_1991_2000.nc')
# ds_3 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Canarias/SST_2001_2015.nc')
# ds_4 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Canarias/SST_2016_2022.nc')
...
##Numerical Model Sea water potential T, bottomT and MLD
#Regridding datasets into satellite ds dimensions and Merging 3 datasets in 1
# ds_GLORYS = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\Canarias/GLORYS_bottomT_T_MLD_1993_2020.nc')
# ds_1 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\Canarias/T_2021_2022.nc')
# ds_2 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\Canarias/bottomT_MLD_2021_2022.nc')
...
# Shapefile = gpd.read_file('E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\canarias\cn.shp', crs="epsg:4326")
# clipped = ds_merged.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas/Numerical_Model_GLORYS/Canarias/GLORYS_Canary_clipped.nc')
...
##CHL & PFT
#Clipping dataset to shapefile dimension
# OC_dataset = xr.open_mfdataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Canarias\*.nc', parallel=True)
...
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Canarias/OC_Canarias_clipped.nc')

#Load the previously-clipped OC dataset
ds_OC_canarias = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Canarias/OC_Canarias_clipped.nc')
...
##BATHYMETRY
#Clipping dataset to shapefile dimension
# BAT_dataset = xr.open_dataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry\Canarias\Canarias_Bathymetry.nc')
# BAT_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# BAT_dataset.rio.write_crs("epsg:4326", inplace=True)
Shapefile_Canarias = gpd.read_file('E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\canarias\cn.shp', crs="epsg:4326")
...
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry\Canarias/Bathy_Canarias_clipped.nc')
...
##Satellite SST
#Regridding datasets into satellite ds_1 dimensions and Merging 3 datasets in 1
# ds_1 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Golfo_Cadiz/SST_1982_2020.nc')
# ds_2 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Golfo_Cadiz/SST_2021_2022.nc')

# # ds_4 = ds_2.rename({'sst': 'analysed_sst'})
# #Define the new latitude and longitude grids
# new_lat = np.asarray(ds_Model_GC.latitude)
# new_lon = np.asarray(ds_Model_GC.longitude)
# #Interpolate ds_GLORYS, ds_1 and ds_2 datasets to the higher-resolution satellite ds grid
# ds_1 = ds_1.interp(lat=new_lat, lon=new_lon)
# ds_2 = ds_2.interp(lat=new_lat, lon=new_lon)
...
# clipped = ds_merged.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Golfo_Cadiz/SST_GC_clipped.nc')
...
start_date = '1993-01-01'
end_date = '2022-12-31'
sst_GC = sst_GC.sel(time=slice(start_date, end_date))


Aver_SST_GC =sst_GC.mean(dim=('time'), skipna=True)#.load() #Average SST 1993-2022



##Numerical Model Sea water potential T, bottomT and MLD
#Regridding datasets into satellite ds dimensions and Merging 3 datasets in 1
# ds_GLORYS = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\GC/GLORYS_bottomT_T_MLD_1993_2020.nc')
# ds_1 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\GC/T_2021_2022.nc')
# ds_2 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\GC/bottomT_MLD_2021_2022.nc')
# ds_2 = ds_2.rename({'tob': 'bottomT'})
# #Define the new latitude and longitude grids
# new_lat = np.asarray(ds_GC.lat)
# new_lon = np.asarray(ds_GC.lon)
# #Interpolate ds_GLORYS, ds_1 and ds_2 datasets to the higher-resolution satellite ds grid
# ds_GLORYS = ds_GLORYS.interp(latitude=new_lat, longitude=new_lon)
# ds_1 = ds_1.interp(latitude=new_lat, longitude=new_lon)
# ds_2 = ds_2.interp(latitude=new_lat, longitude=new_lon)
...
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\sa\sa.shp', crs="epsg:4326")
# clipped = ds_merged.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas/Numerical_Model_GLORYS/GC/Temp_GLORYS_GC_clipped.nc')

#Load the previously-clipped dataset
ds_Model_GC = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas/Numerical_Model_GLORYS\GC\Temp_MLD_GLORYS_GC_clipped.nc')

MLD_GC = ds_Model_GC['mlotst']
lon_GC_MODEL = ds_Model_GC['longitude']
lat_GC_MODEL = ds_Model_GC['latitude']
LON_GC_MODEL, LAT_GC_MODEL = np.meshgrid(lon_GC_MODEL, lat_GC_MODEL)
...
ds_Model_GC.bottomT.mean(dim='time', skipna=True).plot()
...
##CHL & PFT
#Clipping dataset to shapefile dimension
# OC_dataset = xr.open_mfdataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Golfo_Cadiz\*.nc', parallel=True)
# OC_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# OC_dataset.rio.write_crs("epsg:4326", inplace=True)
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\sa\sa.shp', crs="epsg:4326")

# clipped = OC_dataset.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Golfo_Cadiz/OC_GC_clipped.nc')

#Load the previously-clipped OC dataset
ds_OC_GC = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Golfo_Cadiz/OC_GC_clipped.nc')
...
start_date = '1998-01-01'
end_date = '2022-12-31'
CHL_GC = CHL_GC.sel(time=slice(start_date, end_date))

Aver_CHL_GC =CHL_GC.mean(dim=('time'))#.load() #Average CHL 1998-2022
Aver_CHL_GC.plot()
...
##BATHYMETRY
#Clipping dataset to shapefile dimension
# BAT_dataset = xr.open_dataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry\GC\GC_Bathymetry.nc')
# BAT_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# BAT_dataset.rio.write_crs("epsg:4326", inplace=True)
Shapefile_GC = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\sa\sa.shp', crs="epsg:4326")

# clipped = BAT_dataset.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped['elevation'].attrs.pop('grid_mapping', None)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry\GC/Bathy_GC_clipped.nc')
...
##Satellite SST
#Regridding datasets into satellite ds_1 dimensions and Merging 3 datasets in 1
# ds_1 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Alboran/SST_1982_2020.nc')
# ds_2 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Alboran/SST_2021_2022.nc')
...
# ds_merged.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# ds_merged.rio.write_crs("epsg:4326", inplace=True)
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\alb\alb.shp', crs="epsg:4326")

# clipped = ds_merged.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Alboran/SST_AL_clipped.nc')
...
##Numerical Model Sea water potential T, bottomT and MLD
#Regridding datasets into satellite ds dimensions and Merging 3 datasets in 1
# ds_GLORYS = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\AL/GLORYS_bottomT_T_MLD_1993_2020.nc')
# ds_1 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\AL/T_2021_2022.nc')
# ds_2 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\AL/bottomT_MLD_2021_2022.nc')
# ds_2 = ds_2.rename({'tob': 'bottomT'})
# #Define the new latitude and longitude grids
...
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\alb\alb.shp', crs="epsg:4326")
# clipped = ds_merged.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas/Numerical_Model_GLORYS/AL/Temp_GLORYS_AL_clipped.nc')

#Load the previously-clipped dataset
ds_Model_AL = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas/Numerical_Model_GLORYS\AL\Temp_MLD_GLORYS_AL_clipped.nc')

MLD_AL = ds_Model_AL['mlotst']
...
##CHL & PFT
#Clipping dataset to shapefile dimension
# OC_dataset = xr.open_mfdataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Alboran\*.nc', parallel=True)
# OC_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# OC_dataset.rio.write_crs("epsg:4326", inplace=True)
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\alb\alb.shp', crs="epsg:4326")

# clipped = OC_dataset.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Alboran/OC_AL_clipped.nc')

#Load the previously-clipped OC dataset
ds_OC_AL = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Alboran/OC_AL_clipped.nc')
...
##BATHYMETRY
#Clipping dataset to shapefile dimension
# BAT_dataset = xr.open_dataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry\AL\AL_Bathymetry.nc')
# BAT_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# BAT_dataset.rio.write_crs("epsg:4326", inplace=True)
Shapefile_AL = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\alb\alb.shp', crs="epsg:4326")

# clipped = BAT_dataset.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped['elevation'].attrs.pop('grid_mapping', None)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry\AL/Bathy_AL_clipped.nc')
...
##Satellite SST
#Regridding datasets into satellite ds_1 dimensions and Merging 3 datasets in 1
# ds_1 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Baleares/SST_1982_2020.nc')
# ds_2 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Baleares/SST_2021_2022.nc')
...
# ds_merged.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# ds_merged.rio.write_crs("epsg:4326", inplace=True)
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\bl\bl.shp', crs="epsg:4326")

# clipped = ds_merged.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Baleares/SST_BAL_clipped.nc')
...
##Numerical Model Sea water potential T, bottomT and MLD
#Regridding datasets into satellite ds dimensions and Merging 3 datasets in 1
# ds_1 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\BAL/T_1993_2005.nc')
# ds_2 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\BAL/T_2006_2015.nc')
# ds_3 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\BAL/T_2016_2020.nc')
# ds_4 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\BAL/T_2021_2022.nc')
...
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\bl\bl.shp', crs="epsg:4326")
# clipped = ds_merged.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas/Numerical_Model_GLORYS/BAL/T_GLORYS_BAL_clipped.nc')

#Load the previously-clipped dataset
ds_Model_BAL = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas/Numerical_Model_GLORYS\BAL\MLD_GLORYS_BAL_clipped.nc')

MLD_BAL = ds_Model_BAL['mlotst']
...
##CHL & PFT
#Clipping dataset to shapefile dimension
# OC_dataset = xr.open_mfdataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Baleares\*.nc', parallel=True)
# OC_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# OC_dataset.rio.write_crs("epsg:4326", inplace=True)
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\bl\bl.shp', crs="epsg:4326")

# clipped = OC_dataset.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Baleares/OC_BAL_clipped.nc')

#Load the previously-clipped OC dataset
ds_OC_BAL = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour\Baleares/OC_BAL_clipped.nc')
...
##BATHYMETRY
#Clipping dataset to shapefile dimension
# BAT_dataset = xr.open_dataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry/BAL/BAL_Bathymetry.nc')
# BAT_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# BAT_dataset.rio.write_crs("epsg:4326", inplace=True)
Shapefile_BAL = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\bl\bl.shp', crs="epsg:4326")

# clipped = BAT_dataset.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped['elevation'].attrs.pop('grid_mapping', None)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry/BAL/Bathy_BAL_clipped.nc')
...
# ds_005 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Noratlantica/cmems-IFREMER-ATL-SST-L4-REP-OBS_FULL_TIME_SERIE_1680083317616_1982_2018.nc')
# ds_002 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Noratlantica/IFREMER-ATL-SST-L4-NRT-OBS_FULL_TIME_SERIE_1680083467094_2019_2022.nc')
...
# ds_merged.to_netcdf(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Noratlantica/SST_NA_merged.nc')

# ##Clipping dataset to shapefile dimension
# SST_dataset = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Noratlantica/SST_NA_merged.nc')
# SST_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# SST_dataset.rio.write_crs("epsg:4326", inplace=True)
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\galicia\gl.shp', crs="epsg:4326")

# clipped = SST_dataset.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_SST\Noratlantica/SST_NA_clipped.nc')
...
##Numerical Model Sea water potential T, bottomT and MLD
#Regridding datasets into satellite ds dimensions and Merging 3 datasets in 1
# ds_1 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\NA/MLD_1993_2015.nc')
# ds_2 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\NA/MLD_2016_2020.nc')
# ds_3 = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Numerical_Model_GLORYS\NA/MLD_2021_2022.nc')
...
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\galicia\gl.shp', crs="epsg:4326")
# clipped = ds_merged.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas/Numerical_Model_GLORYS/NA/MLD_GLORYS_NA_clipped.nc')

#Load the previously-clipped dataset
ds_Model_NA = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas/Numerical_Model_GLORYS\NA\MLD_GLORYS_NA_clipped.nc')

MLD_NA = ds_Model_NA['mlotst']
...
##CHL & PFT
#Clipping dataset to shapefile dimension
# OC_dataset = xr.open_mfdataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour/Noratlantica/*.nc', parallel=True)
# OC_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# OC_dataset.rio.write_crs("epsg:4326", inplace=True)
# Shapefile = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\galicia\gl.shp', crs="epsg:4326")

# clipped = OC_dataset.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour/Noratlantica/OC_NA_clipped.nc')

#Load the previously-clipped OC dataset
ds_OC_NA = xr.open_dataset(r'E:\ICMAN-CSIC\Estrategias_Marinas\Datos_OceanColour/Noratlantica/OC_NA_clipped.nc')
...
##BATHYMETRY
#Clipping dataset to shapefile dimension
# BAT_dataset = xr.open_dataset('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry/NA/NA_Bathymetry.nc')
# BAT_dataset.rio.set_spatial_dims(x_dim="lon", y_dim="lat", inplace=True)
# BAT_dataset.rio.write_crs("epsg:4326", inplace=True)
Shapefile_NA = gpd.read_file(r'E:\ICMAN-CSIC\Estrategias_Marinas\Demarcaciones_Marinas\shapes\galicia\gl.shp', crs="epsg:4326")

# clipped = BAT_dataset.rio.clip(Shapefile.geometry.apply(mapping), Shapefile.crs, drop=False)
# clipped['elevation'].attrs.pop('grid_mapping', None)
# clipped.to_netcdf('E:\ICMAN-CSIC\Estrategias_Marinas\Datos_Bathymetry/NA/Bathy_NA_clipped.nc')
